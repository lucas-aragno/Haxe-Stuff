...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "hello_world", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "hello_world";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "hello_world", null, { width: 640, height: 480 });
